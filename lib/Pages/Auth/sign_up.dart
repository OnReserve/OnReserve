                  ...
                  children: [
                    TextFormField(
                      ...
                      onFieldSubmitted: (value) =>
                          signUpController.firstnameFocusNode.requestFocus(),
                    ...
                    TextFormField(
                      ...
                      validator: ValidationBuilder()
                          ...
                          .build(),
                      onFieldSubmitted: (value) =>
                          signUpController.password2FocusNode.requestFocus(),
                      obscureText: true,
                      decoration: InputDecoration(
                        hintText: 'Password',
                        hintStyle: TextStyle(
                          ...
                          return Column(
                            children: [
                              RoundedLoadingButton(
                                ...
                                controller: signUpController.btnController,
                                onPressed: () async {
                                  if (logInFormKey.currentState!
                                      .validate()) if (!await signUpController.signUp()) {
